...
if(NOT libkeccak)
   ...
   include(FetchContent)
    ...
    set_target_properties(ethash::ethash PROPERTIES IMPORTED_LOCATION ${keccak_LIBRARY})#/home/julien/dev3/localGMP/external/ethash/lib/keccak/libkeccak.a)
    target_include_directories(ethash::ethash INTERFACE ${ethash_INCLUDE_DIR}) #/home/julien/dev3/localGMP/external/ethash/include)
endif()
